...
self.addEventListener('activate', (e) => {
  e.waitUntil(
    caches.keys()
      ...
      // No forced reload: pages fetch network-first, so the next navigation is
      // fresh anyway. Reloading here yanked visitors out of forms/Calendly mid-flow.
  );
});
